...
function easypanel_CreateAccount(array $params)
{
    try {
        ...
        $services = $sdk->createService($clientId, $params['configoption3'], $params['serviceid'], $params['domain']);
...
class EasyPanelSDK {
    ...
    public function createService($clientId, $templateName, $serviceNamePrefix, $domain) {
        // API endpoint URL
